...
import com.lunacia.scorems.domain.Analyze;
...
public class LeaderController {
	...
	*/
	...
	public HashMap<String, Object> getClassify(@RequestParam(value = "class_num") int classNum,
		...
		Analyze grate1 = new Analyze(), well1 = new Analyze() , pass1 = new Analyze() , unpass1 = new Analyze();
		grate1.setName("优秀");  grate1.setValue(grate);
		well1.setName("良好");  well1.setValue(well);
		pass1.setName("及格");  pass1.setValue(pass);
		unpass1.setName("不及格");  unpass1.setValue(unpass);

		List<Object> list = new LinkedList<>();
		list.add(grate1); list.add(well1); list.add(pass1); list.add(unpass1);
	...
	@GetMapping("/api/getClassAvg")
	public HashMap<String , Object>getClassAvg(@RequestParam("info_id") int infoId , @RequestParam("class_num")int classNum){
		HashMap<String , Object> hashMap = new HashMap<>();
		hashMap.put("data" , leaderMapper.getClassAvg(infoId , classNum));
		hashMap.put("code" , 200);
		hashMap.put("message" , "");
		return hashMap;
	}
